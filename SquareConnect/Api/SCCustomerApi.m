...
@interface SCCustomerApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SCCustomerApi

NSString* kSCCustomerApiErrorDomain = @"SCCustomerApiErrorDomain";
NSInteger kSCCustomerApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SCCustomerApi *sharedAPI;
...
///
///  @returns SCCreateCustomerResponse*
///
-(NSNumber*) createCustomerWithAuthorization: (NSString*) authorization
    ...
    if (authorization == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSCCustomerApiErrorDomain code:kSCCustomerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SCCreateCustomerResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SCCreateCustomerResponse*)data, error);
                                }
                           }
          ];
}
...
///  @param customerId  
///
///  @returns SCDeleteCustomerResponse*
///
-(NSNumber*) deleteCustomerWithAuthorization: (NSString*) authorization
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SCDeleteCustomerResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SCDeleteCustomerResponse*)data, error);
                                }
                           }
          ];
}
...
///
///  @returns SCListCustomersResponse*
///
-(NSNumber*) listCustomersWithAuthorization: (NSString*) authorization
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SCListCustomersResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SCListCustomersResponse*)data, error);
                                }
                           }
          ];
}
...
///  @param customerId  
///
///  @returns SCRetrieveCustomerResponse*
///
-(NSNumber*) retrieveCustomerWithAuthorization: (NSString*) authorization
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SCRetrieveCustomerResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SCRetrieveCustomerResponse*)data, error);
                                }
                           }
          ];
}
...
///  @param body An object containing the fields to POST for the request.  See the corresponding object definition for field details. 
///
///  @returns SCUpdateCustomerResponse*
///
-(NSNumber*) updateCustomerWithAuthorization: (NSString*) authorization
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SCUpdateCustomerResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SCUpdateCustomerResponse*)data, error);
                                }
                           }
          ];
}
