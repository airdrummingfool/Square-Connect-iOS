#import "SCLocationApi.h"
#import "SCQueryParamCollection.h"
#import "SCListLocationsResponse.h"


@interface SCLocationApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SCLocationApi

NSString* kSCLocationApiErrorDomain = @"SCLocationApiErrorDomain";
NSInteger kSCLocationApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SCLocationApi *sharedAPI;
...
///
///  @returns SCListLocationsResponse*
///
-(NSNumber*) listLocationsWithAuthorization: (NSString*) authorization
    ...
    if (authorization == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSCLocationApiErrorDomain code:kSCLocationApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SCListLocationsResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SCListLocationsResponse*)data, error);
                                }
                           }
          ];
}
