...
@interface SQCCustomerApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SQCCustomerApi

NSString* kSQCCustomerApiErrorDomain = @"SQCCustomerApiErrorDomain";
NSInteger kSQCCustomerApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SQCCustomerApi *sharedAPI;
...
///
///  @returns SQCCreateCustomerResponse*
///
-(NSNumber*) createCustomerWithAuthorization: (NSString*) authorization
    ...
    if (authorization == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSQCCustomerApiErrorDomain code:kSQCCustomerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SQCCreateCustomerResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SQCCreateCustomerResponse*)data, error);
                                }
                           }
          ];
}
...
///  @param customerId  
///
///  @returns SQCDeleteCustomerResponse*
///
-(NSNumber*) deleteCustomerWithAuthorization: (NSString*) authorization
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SQCDeleteCustomerResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SQCDeleteCustomerResponse*)data, error);
                                }
                           }
          ];
}
...
///
///  @returns SQCListCustomersResponse*
///
-(NSNumber*) listCustomersWithAuthorization: (NSString*) authorization
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SQCListCustomersResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SQCListCustomersResponse*)data, error);
                                }
                           }
          ];
}
...
///  @param customerId  
///
///  @returns SQCRetrieveCustomerResponse*
///
-(NSNumber*) retrieveCustomerWithAuthorization: (NSString*) authorization
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SQCRetrieveCustomerResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SQCRetrieveCustomerResponse*)data, error);
                                }
                           }
          ];
}
...
///  @param body An object containing the fields to POST for the request.  See the corresponding object definition for field details. 
///
///  @returns SQCUpdateCustomerResponse*
///
-(NSNumber*) updateCustomerWithAuthorization: (NSString*) authorization
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SQCUpdateCustomerResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SQCUpdateCustomerResponse*)data, error);
                                }
                           }
          ];
}
