...
@interface SQCRefundApi: NSObject <SQCApi>

extern NSString* kSQCRefundApiErrorDomain;
extern NSInteger kSQCRefundApiMissingParamErrorCode;
...
///
/// @return SQCCreateRefundResponse*
