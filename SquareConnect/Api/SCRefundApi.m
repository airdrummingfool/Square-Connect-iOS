...
@interface SCRefundApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SCRefundApi

NSString* kSCRefundApiErrorDomain = @"SCRefundApiErrorDomain";
NSInteger kSCRefundApiMissingParamErrorCode = 234513;
...
///
///  @returns SCCreateRefundResponse*
///
-(NSNumber*) createRefundWithAuthorization: (NSString*) authorization
    ...
    if (authorization == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSCRefundApiErrorDomain code:kSCRefundApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/locations/{location_id}/transactions/{transaction_id}/refund"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SCCreateRefundResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SCCreateRefundResponse*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) listRefundsWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/v2/locations/{location_id}/refunds"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SCListRefundsResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SCListRefundsResponse*)data, error);
                                }
                           }
          ];
}
