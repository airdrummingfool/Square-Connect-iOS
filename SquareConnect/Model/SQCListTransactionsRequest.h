...
@protocol SQCListTransactionsRequest
@end

@interface SQCListTransactionsRequest : SQCObject
...
/* The order in which results are listed in the response (`ASC` for chronological, `DESC` for reverse-chronological). [optional]
 */
