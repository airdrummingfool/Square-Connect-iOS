 ...
 */
extern NSString *const SCResponseObjectErrorKey;
...
/// In order to ensure the HTTPResponseHeaders are correct, it is recommended to initialize one SCApiClient instance per thread.
@property(nonatomic, readonly) NSDictionary* HTTPResponseHeaders;

@property(nonatomic, strong) id<SCResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<SCSanitizer> sanitizer;
/**
 * Clears Cache
 */
+(void)clearCache;
...
/**
 * SCConfiguration return sharedConfig
 *
