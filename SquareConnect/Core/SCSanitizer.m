#import "SCSanitizer.h"
#import "SCObject.h"
#import "SCQueryParamCollection.h"
#import <ISO8601/ISO8601.h>

NSString * SCPercentEscapedStringFromString(NSString *string) {
    static NSString * const kSCCharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kSCCharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kSCCharactersGeneralDelimitersToEncode stringByAppendingString:kSCCharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[SCQueryParamCollection class]]) {
        return object;
    }
    ...
    else if ([object isKindOfClass:[SCObject class]]) {
