...
#ifndef SCDebugLogResponse
#define SCDebugLogResponse(response, responseObject,request, error) [[SCLogger sharedLogger] logResponse:response responseObject:responseObject request:request error:error];
#endif
 ...
 */
#ifndef SCDebugLog
#define SCDebugLog(format, ...) [[SCLogger sharedLogger] debugLog:[NSString stringWithFormat:@"%s", __PRETTY_FUNCTION__] message: format, ##__VA_ARGS__];
#endif
...
/**
 * Enabled switch, default NO - default set by SCConfiguration debug property
 */
