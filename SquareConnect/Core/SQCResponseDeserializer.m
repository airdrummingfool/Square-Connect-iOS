...
NSString *const SQCDeserializationErrorDomainKey = @"SQCDeserializationErrorDomainKey";

NSInteger const SQCTypeMismatchErrorCode = 143553;

NSInteger const SQCEmptyValueOccurredErrorCode = 143509;

NSInteger const SQCUnknownResponseObjectErrorCode = 143528;


@interface SQCResponseDeserializer ()
...
@implementation SQCResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:SQCDeserializationErrorDomainKey code:SQCTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:SQCDeserializationErrorDomainKey code:SQCEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:SQCDeserializationErrorDomainKey code:SQCUnknownResponseObjectErrorCode userInfo:userInfo];
}
