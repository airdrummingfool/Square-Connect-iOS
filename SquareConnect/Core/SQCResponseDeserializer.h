 ...
 */
extern NSString *const SQCDeserializationErrorDomainKey;

/**
 * Code for deserialization type mismatch error
 */
extern NSInteger const SQCTypeMismatchErrorCode;

/**
 * Code for deserialization empty value error
 */
extern NSInteger const SQCEmptyValueOccurredErrorCode;

/**
 * Error code for unknown response
 */
extern NSInteger const SQCUnknownResponseObjectErrorCode;

@protocol SQCResponseDeserializer <NSObject>
...
@interface SQCResponseDeserializer : NSObject <SQCResponseDeserializer>
