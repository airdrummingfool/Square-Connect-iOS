 ...
 */
extern NSString *const SCDeserializationErrorDomainKey;

/**
 * Code for deserialization type mismatch error
 */
extern NSInteger const SCTypeMismatchErrorCode;

/**
 * Code for deserialization empty value error
 */
extern NSInteger const SCEmptyValueOccurredErrorCode;

/**
 * Error code for unknown response
 */
extern NSInteger const SCUnknownResponseObjectErrorCode;

@protocol SCResponseDeserializer <NSObject>
...
@interface SCResponseDeserializer : NSObject <SCResponseDeserializer>
