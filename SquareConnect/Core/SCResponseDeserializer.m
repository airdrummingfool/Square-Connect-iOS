#import "SCResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const SCDeserializationErrorDomainKey = @"SCDeserializationErrorDomainKey";

NSInteger const SCTypeMismatchErrorCode = 143553;

NSInteger const SCEmptyValueOccurredErrorCode = 143509;

NSInteger const SCUnknownResponseObjectErrorCode = 143528;


@interface SCResponseDeserializer ()
...
@implementation SCResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:SCDeserializationErrorDomainKey code:SCTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:SCDeserializationErrorDomainKey code:SCEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:SCDeserializationErrorDomainKey code:SCUnknownResponseObjectErrorCode userInfo:userInfo];
}
