...
NSString * SQCPercentEscapedStringFromString(NSString *string) {
    static NSString * const kSQCCharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kSQCCharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kSQCCharactersGeneralDelimitersToEncode stringByAppendingString:kSQCCharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[SQCQueryParamCollection class]]) {
        return object;
    }
    ...
    else if ([object isKindOfClass:[SQCObject class]]) {
